...
const {SetupAPI, AuthorizationsAPI, SigninAPI, OrgsAPI, SignoutAPI, PingAPI} = require('@influxdata/influxdb-client-apis')
...
class InfluxdbClient {
    ...
    #initClients() {
        this.#baseClient = new InfluxDB({url: this.#baseUrl, timeout: this.#timeout, transportOptions: this.#transportOptions})
